...
import org.data2semantics.mustard.experiments.modules.kernels.RDFIntersectionPartialSubTreeKernelModule;
...
/**
 * This is the model implementation of RDFIntersectionPartialSubTreeKernel.
 * 
 *
 * @author Adianto Wibisono
 */
public class RDFIntersectionPartialSubTreeKernelNodeModel extends RDFDataModelAbstractClass {
    
    // the logger instance
    private static final NodeLogger logger = NodeLogger
            .getLogger(RDFIntersectionPartialSubTreeKernelNodeModel.class);
    ...
    static final String CFG_DEPTH  				= "Depth";
   	...
   	private final SettingsModelIntegerBounded depth  =    
   			new SettingsModelIntegerBounded(RDFIntersectionPartialSubTreeKernelNodeModel.CFG_DEPTH,
   	...
   	private final SettingsModelBoolean inference =    new SettingsModelBoolean(RDFIntersectionPartialSubTreeKernelNodeModel.CFG_INFERENCE,
   			RDFIntersectionPartialSubTreeKernelNodeModel.DEFAULT_INFERENCE);
   	    
       private final SettingsModelBoolean normalize =    new SettingsModelBoolean(RDFIntersectionPartialSubTreeKernelNodeModel.CFG_NORMALIZE,
    		   RDFIntersectionPartialSubTreeKernelNodeModel.DEFAULT_NORMALIZE);
       
    /**
     * Constructor for the node model.
     */
    protected RDFIntersectionPartialSubTreeKernelNodeModel() {
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData,
        ...
        RDFIntersectionPartialSubTreeKernelModule module = new RDFIntersectionPartialSubTreeKernelModule(
        		depth.getIntValue(), 
